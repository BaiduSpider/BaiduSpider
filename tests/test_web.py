...
class WebTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.video_query = 'Python'
        self.video_res = {
            'title': '5分钟学会Python爬取整个网站',
            'url': 'http://www.bilibili.com/video/av66756070/',
            'cover': 'https://vdposter.bdstatic.com/c655e2bcd8201a2d2505aca6efbe3879.jpeg?x-bce-process=image/resize,m_fill,w_256,h_170/format,f_jpg/quality,Q_100',
            'length': '09:22',
            'origin': 'B站'
        }
